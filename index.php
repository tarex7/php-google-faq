...
$FAQ = [
    ...
    [
        ...
        [
            ...
            "<ol>
            <li class='mb-3'>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
                <ol type='a'>
                    <li class='my-3'>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
                    <li class='my-3'>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li>
                </ol>
            </li>
            <li class='mb-3'>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li>
        </ol>",

            "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.",

            "<h5 class='mt-5'>Stabilire il paese associato al tuo account</h5>",
            ...
            "Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <a href='https://policies.google.com/country-association-form'>Contattaci</a>  se ritieni che il paese associato al tuo account sia sbagliato.",
            ...
            <header class="py-4">
                <div>
                    <div class="d-flex align-items-center justify-content-between px-2 mb-2">
                        <div>
                            <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="logo" id="logo" class="ms-2">
                            <span class="ms-1">Privacy e termini</span>
                        </div>
                        <div>
                            <i class="fa-solid fa-list-ul fa-2x me-3"></i>
                        </div>
                    </div>
                </div>
                <div>
